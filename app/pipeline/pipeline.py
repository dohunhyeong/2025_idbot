...
class RagPipeline:
    def __init__(
        ...
        *,
        ...
        self.grade_service = grade_service  # ✅ 추가
    ...
    async def run(self, user_query: str) -> dict:
        ...
        if self.grade_service.is_grade_question(query_obj.raw_text):
            ...
            doc = {
                ...
                "retrievers_used": [],               # ✅ RAG 미사용
                "retriever_results": [],             # ✅ 없음
                "final_answer": final_answer,
                "query_time": query_time,
                "response_time": response_time,
                "latency_ms": latency_ms,
                "mode": "grade_only",                # ✅ 구분용(선택)
            }
        ...
        # 5) Retriever 병렬 실행 (answer + context)
        tasks = [r.ainvoke_with_context(query_obj.normalized_text) for r in retrievers]
